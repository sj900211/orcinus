...
const ATOM_FEED_URL = 'https://github.com/sj900211/orcinus/releases.atom'
const RELEASES_DOWNLOAD_BASE = 'https://github.com/sj900211/orcinus/releases/download'
...
const TAG_HREF_RE = /href="https:\/\/github\.com\/sj900211\/orcinus\/releases\/tag\/([^"]+)"/g
