...
import {
  SatelliteWindowSessionPersistence,
  installSatelliteWindowSessionPersistenceContext
} from './satellite-window-session-persistence'
import {
...
export type StoreDomains = {
  ...
  satelliteWindowSessions: SatelliteWindowSessionPersistence
...
export function installStoreDomainContexts(target: object, domains: StoreDomains): void {
  ...
  installSatelliteWindowSessionPersistenceContext(target, domains.satelliteWindowSessions)
...
export function createStoreDomains(runtime: StoreRuntimeState): StoreDomains {
  ...
  const satelliteWindowSessions = new SatelliteWindowSessionPersistence(runtime, scheduling)
