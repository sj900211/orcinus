...
import { projectWindowApi } from './api/project-window-bridge'
import { satelliteWindowApi } from './api/satellite-window-bridge'
import { sftpBridgeApi } from './api/sftp-bridge'
...
const api = {
  ...
  satelliteWindow: satelliteWindowApi,
  pty: ptyApi,
