    ...
    api: new Proxy(
      {
        ...
        // Why: the mirror hydration awaits getMirror, so the default function stub would throw.
        satelliteWindow: createApiNamespaceStub({ getMirror: () => Promise.resolve(null) }),
