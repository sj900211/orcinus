...
import { createProjectWindowsSlice } from './slices/project-windows'
import { createSatelliteMirrorSlice } from './slices/satellite-mirror'
  ...
  withDevelopmentStoreProbes(
    withReactCommitCascadeWriteProbe((...a) => {
      ...
      return {
        ...
        // Fork slices (project windows + satellite mirror) — kept past upstream's list.
